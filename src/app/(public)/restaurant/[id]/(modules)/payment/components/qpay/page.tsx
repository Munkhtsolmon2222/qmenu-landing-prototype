...
export const ConvertQpayBankImg = {
  [QPAY_BANK_TYPE.MBANK]: mbank,
  [QPAY_BANK_TYPE.KHAAN_BANK]: khaan,
  [QPAY_BANK_TYPE.KHAS_BANK]: khasBank,
  [QPAY_BANK_TYPE.BOGD_BANK]: bogdBank,
  [QPAY_BANK_TYPE.CAPITRON_BANK]: capitronBank,
  [QPAY_BANK_TYPE.CHINGIG_KHAAN_BANK]: ckBank,
  [QPAY_BANK_TYPE.MOST_MONEY]: most,
  [QPAY_BANK_TYPE.NATIONAL_INVESTMENT_BANK]: taniBank,
  [QPAY_BANK_TYPE.STATE_BANK]: stateBank,
  [QPAY_BANK_TYPE.TRADE_AND_DEVELOPMENT_BANK]: tbd,
  [QPAY_BANK_TYPE.ARD_APP]: ardapp,
  [QPAY_BANK_TYPE.SOCIAL_PAY]: socialPay,
  [QPAY_BANK_TYPE.MONPAY]: monpay,
  [QPAY_BANK_TYPE.ARIG_BANK]: arig,
  [QPAY_BANK_TYPE.TRANS_BANK]: transabnk,
};
  ...
  return (
    <BlockItem>
      <div className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-6">
        {(payment.type === PAYMENT_TYPE.QPay ? qpyBanks : qpy2Banks).map(
          (bank, index) => {
              ...
              >
                ...
                <Image
                  ...
                  className={`w-16 rounded-lg ${
                    paymentType === bank.type ? "border-4 border-current" : ""
                  }`}
