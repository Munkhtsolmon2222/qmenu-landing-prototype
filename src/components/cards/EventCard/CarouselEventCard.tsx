    ...
    return (
      ...
      >
        <Image
          ...
          height={100}
          className={cn(
            "w-full h-3/5 object-cover z-0 opacity-0 transition-opacity duration-[400ms] ease-in-out transform",
            imageClassName
          )}
        ...
        <div className="w-full h-2/5 rounded-md px-2 py-3">
          ...
          <div className="flex w-full mt-auto">
            <div>
              ...
              <div className="flex flex-nowrap items-center gap-1 rounded mt-3 outline outline-0 text-sm w-28 relative bottom-3">
            ...
            <Button
              className="bg-current-2 hover:bg-current-3 ml-auto mt-1 bg-red-800"
              onClick={(e) => {
                e.stopPropagation();
                onClick?.();
              }}
...
export const Times: React.FC<{ event: IEvent; onClick?: () => void }> = ({
  event,
  onClick,
}) => {
