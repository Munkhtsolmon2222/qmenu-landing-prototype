    ...
    <>
      ...
      <div className="relative z-10">
        <div className="flex items-center space-x-2 mb-24 px-2 py-4">
          <Badge className="bg-red-500 whitespace-nowrap text-nowrap text-white font-bold px-2 py-1 rounded-full">
            1 + 1
          </Badge>
          <Badge className="bg-red-500 text-white font-bold px-2 py-1 rounded-full w-full max-w-max">
            <div className="truncate max-w-48">
              {(discount.getProduct ?? discount.getVariant)?.name}
            </div>
          </Badge>
