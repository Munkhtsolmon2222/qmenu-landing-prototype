...
export function Footer() {
  ...
  return (
    <footer id="footer" className="w-full">
      <div className="justify-center w-full flex items-center rounded-t-xl bg-current-1 px-6 sm:px-14 mt-14">
        <div className="max-w-[90rem] w-full flex-col flex md:flex-row justify-between md:gap-8 md:items-end pt-8 sm:pb-8 gap-1 border-b-[2px] border-gray-600 ">
            ...
            <div className="font-semibold -mt-2.5  text-gray-600 sm:text-center ">
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+97677772040" className="underline cursor-pointer">
                    77772040
                  </a>
                </div>
                <div className="flex items-center gap-3 mt-3  text-gray-600">
                  ...
                  <a href="mailto:info@qmenu.mn" className="underline cursor-pointer">
                    info@qmenu.mn
                  </a>
                </div>
                <div className="flex items-center gap-3 mt-3">
                  ...
                  <a href="tel:+97677772040" className="underline cursor-pointer text-gray-600">
          ...
          <div className="md:items-end sm:justify-start md:gap-6 font-medium mb-5  text-gray-600">
            <NewsletterForm />
          </div>
        </div>
      </div>
      <div className="bg-current-1 text-center py-5 text-gray-500 mb-14 sm:mb-0">
