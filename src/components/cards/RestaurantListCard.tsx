...
import { calculateDistance } from "./RestaurantGridCard";
...
export function RestaurantList(props: Props) {
  ...
  const { onClickLike, liked: like } = useFavourite(
  ...
  return (
    <div
      ...
      className="relative w-full  h-max overflow-hidden border rounded-lg py-2 px-2  "
    >
        ...
        <div className="flex flex-row md:flex-row items-center justify-start gap-1 h-full ">
          <div className="relative">
            <Image
              ...
              src={
                !place?.logo || place.logo === "" ? defaultImage : place?.logo
              }
              style={{
                objectFit: "cover",
              }}
          ...
          <div className="px-2 py-2 md:gap-2 gap-1.5 flex flex-col justify-between overflow-hidden text-ellipsis bg-background ">
            ...
            <div className="pt-0.5 w-full flex items-center gap-2 ">
              <div className="flex items-center gap-1">
                <div>
                  <Icons.navigation className="text-current h-4 w-4" />
                </div>
                <p className="text-sm  xl:text-base text-ellipsis truncate  text-secondary-text opacity-80">
              ...
              <div className="flex items-center gap-1">
                <div>
                  <Icons.store className="fill-white h-4 w-4 text-current" />
                </div>
                <p className=" text-sm  xl:text-base text-ellipsis truncate  text-secondary-text opacity-80">
                  {place?.type}
                </p>
