...
export function getAvailabilityStatus(tableInfo: TableInfo): string {
  const percentage =
    Number((tableInfo?.available * 100) / tableInfo.total) ?? 0;
...
export function FilteredCard(props: Props) {
  ...
  return (
    <div
      className="rounded-2xl border overflow-clip w-full"
      ...
      <div className="px-2 py-2 md:gap-2 gap-1.5 flex flex-col justify-between overflow-hidden text-ellipsis bg-background">
        ...
        <div className="pt-0.5 w-full flex items-center gap-2 ">
          <div className="flex items-center gap-1">
            ...
            <p className="text-sm  xl:text-base text-ellipsis truncate  text-black font-medium opacity-75 ">
          ...
          <div className="flex items-center gap-1">
            <div>
              <Icons.store className="fill-white h-4 w-4 text-black" />
            </div>
            <p className=" text-sm  xl:text-base text-ellipsis truncate  text-black font-medium opacity-75 ">
              {place?.type}
            </p>
